    ...
    <div class="container pt-5">
        <div class="card shadow-sm border-0">
            <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
                <h5 id="AddUserLabel" class="mb-0">تأكد من استيراد  ملف الأكسل الخاصة بالاسهم</h5>
            </div>
            ...
            @endif
                <form class="add-new-user" id="addNewUserForm" action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
