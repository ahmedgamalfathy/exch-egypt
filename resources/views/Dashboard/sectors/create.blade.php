    ...
    <div class="container pt-5">
        <div class="card shadow-sm border-0">
            <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
                <h5 id="AddUserLabel" class="mb-0">تأكد من استيراد  ملف الأكسل الخاص بالقطاعات</h5>
            </div>
            ...
            @endif
                <form class="add-new-user" id="addNewUserForm" action="{{ route('sector.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                {{-- //code , stock_name, closing_price_year, closing_price_today,annual_growth_rate
                    ...
                    //external_liquidity_value, net_liquidity,liquidity_ratio,trading_volume --}}
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="add-user-fullname">استيراد الملف</label>
